...
declare module "rxjs/ajax/internal/observable/dom/ajax" {
  declare export var ajax: AjaxCreationMethod;
}
declare module "rxjs/ajax/internal/observable/dom/AjaxObservable" {
  ...
  declare export interface AjaxCreationMethod {
  ...
  declare export function ajaxGet(
    url: string,
    headers?: Object
  ): AjaxObservable<AjaxResponse>;

  declare export function ajaxPost(
    url: string,
    body?: any,
    headers?: Object
  ): Observable<AjaxResponse>;

  declare export function ajaxDelete(
    url: string,
    headers?: Object
  ): Observable<AjaxResponse>;

  declare export function ajaxPut(
    url: string,
    body?: any,
    headers?: Object
  ): Observable<AjaxResponse>;

  declare export function ajaxPatch(
    url: string,
    body?: any,
    headers?: Object
  ): Observable<AjaxResponse>;

  declare export function ajaxGetJSON<T>(
    url: string,
    headers?: Object
  ): Observable<T>;
   ...
   * @hide  true
   */
  declare export class AjaxObservable<T> mixins Observable<T> {
    /**
...
the Observable. Gets {
 * @link  AjaxResponse} as an argument.
...
*/
    ...
    constructor(urlOrRequest: string | AjaxRequest): this;
   ...
   * @extends  {Ignored}
   */
  declare export class AjaxSubscriber<T> mixins Subscriber<Event> {
    request: AjaxRequest;
    constructor(destination: Subscriber<T>, request: AjaxRequest): this;
    next(e: Event): void;
    unsubscribe(): void;
  }
  ...
  declare export class AjaxResponse {
    ...
    /**
     *
     * @type  The raw responseText
     */
    responseText: string;

    /**
     *
     * @type  The responseType (e.g. 'json', 'arraybuffer', or 'xml')
     */
    responseType: string;
    constructor(
      originalEvent: Event,
  ...
  declare export type AjaxErrorNames = "AjaxError" | "AjaxTimeoutError";
   ...
   * @class  AjaxError
   */
  declare export type AjaxError = {
    /**
     *
     * @type  The XHR instance associated with the error
     */
    xhr: XMLHttpRequest,

    /**
     *
     * @type  The AjaxRequest associated with the error
     */
    request: AjaxRequest,
  ...
  declare export interface AjaxErrorCtor {
    new(message: string, xhr: XMLHttpRequest, request: AjaxRequest): AjaxError;
  }
  declare export var AjaxError: AjaxErrorCtor;
  declare export type AjaxTimeoutError = {} & AjaxError;

  declare export interface AjaxTimeoutErrorCtor {
    new(xhr: XMLHttpRequest, request: AjaxRequest): AjaxTimeoutError;
  }
  declare export var AjaxTimeoutError: AjaxTimeoutErrorCtor;
}
declare module "rxjs/ajax/internal/Observable" {
  /**
...
declare module "rxjs/ajax/internal/Subscriber" {
  /**
...
declare module "rxjs/ajax/internal/types" {
  /**
   * OPERATOR INTERFACES
   */
...
declare module "rxjs/ajax/internal/Operator" {
  declare export interface Operator<T, R> {
    call(subscriber: Subscriber<R>, source: any): TeardownLogic;
  }
}
declare module "rxjs/ajax/internal/Subscription" {
  /**
...
declare module "rxjs/ajax/internal/observable/iif" {
  /**
...
declare module "rxjs/ajax/internal/observable/throwError" {
  /**
